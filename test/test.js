...
describe("discrepances", function(){
    [
        ...
        {a:"un negro pez"        , b:"un blanco pez"    , expect: {difference: {left:'negro', right:'blanco', pos:3}, values:["un negro pez", "un blanco pez"]}        },
        {a:"un pez negro"        , b:"un pez blanco"    , expect: {difference: {left:'negro', right:'blanco', pos:7}, values:["un pez negro", "un pez blanco"]}                        },
        {a:"negro el ocho"       , b:"rojo el ocho"     , expect: {difference: {left:'negro', right:'rojo', pos:0}, values:["negro el ocho", "rojo el ocho"]}                        },
